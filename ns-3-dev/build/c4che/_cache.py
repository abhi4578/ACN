...
CFLAGS_PYEMBED = ['-march=nocona', '-mtune=haswell', '-ftree-vectorize', '-fPIC', '-fstack-protector-strong', '-fno-plt', '-O3', '-ffunction-sections', '-fdebug-prefix-map=/tmp/build/80754af9/python_1565725737370/work=/usr/local/src/conda/python-3.7.4', '-fdebug-prefix-map=/home/abhilash/anaconda3=/usr/local/src/conda-prefix', '-fuse-linker-plugin', '-ffat-lto-objects', '-flto-partition=none', '-flto', '-fwrapv', '-O3']
CFLAGS_cshlib = ['-fPIC']
COMPILER_CC = 'gcc'
COMPILER_CXX = 'g++'
CPPPATH_ST = '-I%s'
...
CXXFLAGS_PYEMBED = ['-march=nocona', '-mtune=haswell', '-ftree-vectorize', '-fPIC', '-fstack-protector-strong', '-fno-plt', '-O3', '-ffunction-sections', '-fdebug-prefix-map=/tmp/build/80754af9/python_1565725737370/work=/usr/local/src/conda/python-3.7.4', '-fdebug-prefix-map=/home/abhilash/anaconda3=/usr/local/src/conda-prefix', '-fuse-linker-plugin', '-ffat-lto-objects', '-flto-partition=none', '-flto', '-fwrapv', '-O3']
...
EXAMPLE_DIRECTORIES = ['routing', 'stats', 'energy', 'udp', 'error-model', 'ipv6', 'wireless', 'matrix-topology', 'udp-client-server', 'realtime', 'traffic-control', 'tutorial', 'naming', 'socket', 'tcp']
...
INCLUDES_PYEMBED = ['/home/abhilash/anaconda3/include/python3.7m']
INFODIR = '/usr/local/share/info'
INT64X64_USE_128 = 1
LIBDIR = '/usr/local/lib'
LIBEXECDIR = '/usr/local/libexec'
LIBPATH_BOOST = ['/usr/lib/x86_64-linux-gnu']
LIBPATH_PYEMBED = ['/home/abhilash/anaconda3/lib/python3.7/config-3.7m-x86_64-linux-gnu', '/home/abhilash/anaconda3/lib']
LIBPATH_ST = '-L%s'
...
NS3_EXECUTABLE_PATH = ['/home/abhilash/projects/ACN/ns-3-allinone/ns-3-dev/build/src/fd-net-device', '/home/abhilash/projects/ACN/ns-3-allinone/ns-3-dev/build/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/7', '/home/abhilash/projects/ACN/ns-3-allinone/ns-3-dev/build/lib', '/home/abhilash/projects/ACN/ns-3-allinone/ns-3-dev/build']
...
PYO = 1
PYTAG = 'cpython-37'
PYTHON = ['/home/abhilash/anaconda3/bin/python3']
PYTHONARCHDIR = '/usr/local/lib/python3.7/site-packages'
PYTHONDIR = '/usr/local/lib/python3.7/site-packages'
PYTHON_CONFIG = ['/home/abhilash/anaconda3/bin/python3-config']
PYTHON_VERSION = '3.7'
...
cfg_files = ['/home/abhilash/projects/ACN/ns-3-allinone/ns-3-dev/build/ns3/config-store-config.h', '/home/abhilash/projects/ACN/ns-3-allinone/ns-3-dev/build/ns3/core-config.h', '/home/abhilash/projects/ACN/ns-3-allinone/ns-3-dev/build/ns3/stats-config.h']
cprogram_PATTERN = '%s'
